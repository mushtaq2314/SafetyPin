...
def signup(request):
    ...
    if request.method == "POST":
        ...
        if email in allmails:
            ...
            signup = SignUP(name= name,email = email,password=encrypt(encpwd.encode(),password.encode()),image = "E:/SEM-III/MP/Mini_Project-1/images/img19_1920x1200.jpg")    
            # signup = SignUP(name= name,email = email,password=encrypt(encpwd.encode(),password.encode()),image = "home/ubuntu/safetypin/images/img19_1920x1200.jpg")    
            signup.save()
            context = {'name':name}
            return render(request,'login.html',context)
...
def store(request):
    ...
    # print(modify)
    x = Image.open("E:/SEM-III/MP/Mini_Project-1/images/img19_1920x1200.jpg")
